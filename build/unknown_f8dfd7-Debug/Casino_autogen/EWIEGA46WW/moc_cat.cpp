...
static constexpr auto qt_meta_stringdata_ZN3CatE = QtMocHelpers::stringData(
    "Cat"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN3CatE[] = {
...
Q_CONSTINIT const QMetaObject Cat::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN3CatE.offsetsAndSizes,
    qt_meta_data_ZN3CatE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN3CatE_t,
        // Q_OBJECT / Q_GADGET
...
void *Cat::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN3CatE.stringdata0))
